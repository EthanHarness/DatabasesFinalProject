...
class Lexer:
    ...
    @staticmethod
    def getTokenFunction(tokenType: str) -> Callable[[int, str], int]:
        match tokenType:
            case Whitespace.TOKEN_STRING: return Whitespace.getNextState
            case Number.TOKEN_STRING: return Number.getNextState
            case StringT.TOKEN_STRING: return StringT.getNextState
            case _: raise Exception("Invalid Token Type")
